...
def rainbowGrid(dimensions, darkness=1):
    """
    ...
    scheme = [
        colors.HexColor(0xba2742),
        colors.HexColor(0xd99b50),
        colors.HexColor(0xf5f573),
        colors.HexColor(0x688057),
        colors.HexColor(0x561f91),
        colors.HexColor(0x94296f),
        ]
